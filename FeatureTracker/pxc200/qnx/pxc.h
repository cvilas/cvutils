...
/***************************************************************************
 | FILE NAME:       PXC.H                                                  |
 | TARGET PLATFORM: QNX6                                                   |
 |                                                                         |
 |             Copyright (c) CyberOptics Semiconductor 2003                |
 ***************************************************************************/
...
short PXC200_OpenLibrary(PXC200 __PX_FAR *iface,short size);
void PXC200_CloseLibrary(PXC200 __PX_FAR *iface);
